...
<?php $__env->startSection('title', 'Countries Quiz - Home'); ?>
...
<div class="text-center">
    ...
    <form action="<?php echo e(route('start.quiz')); ?>" method="POST" style="margin-top: 30px;">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\artem.bulgakov\Desktop\Wendy PHP 2.0\progetto_quiz_WendyArtem\resources\views/home.blade.php ENDPATH**/ ?>